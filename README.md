...
`pip install git+https://github.com/biomodels/BIOMD0000000134.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/BIOMD0000000134.git@20140916`

## Usage

Importing the model package.

`import BIOMD0000000134 as model`
